...
in the Cython extension module :mod:`~hydpy.cythons.smoothutils`.
"""
...
def calc_smoothpar_logistic1(metapar):
    ...
    parameter when using :func:`~hydpy.cythons.smoothutils.smooth_logistic1`.
    ...
    :func:`~hydpy.cythons.smoothutils.smooth_logistic1` differs by
...
"""Return the smoothing parameter corresponding to the given meta
parameter when using :func:`~hydpy.cythons.smoothutils.smooth_logistic3`.

:func:`~hydpy.cythons.smoothutils.smooth_logistic3` is only an alias for
...
:func:`~hydpy.cythons.smoothutils.smooth_logistic1` and
:func:`~hydpy.cythons.smoothutils.smooth_logistic2`, the smoothing
parameter determined for function
:func:`~hydpy.cythons.smoothutils.smooth_logistic3` is not in perfect
agreement with the given meta parameter.  For most purpuses, the

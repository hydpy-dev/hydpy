...
.. integration-test::
    ...
    | 2000-01-01 00:30:00 | 33.726739 |     0.0 |  5.814912 |     0.0 |
    ...
    | 2000-01-01 00:50:00 | 25.854608 |     0.0 |  4.875905 |     0.0 |
    | 2000-01-01 00:55:00 | 24.044617 |     0.0 |  4.680468 |     0.0 |
    ...
    | 2000-01-01 01:50:00 |   6.91179 |     0.0 |  3.080055 |     0.0 |
    ...
    | 2000-01-01 02:50:00 |     300.0 |     0.0 |  1.908478 |     0.0 |
...
.. integration-test::
    ...
    | 2000-01-01 01:00:00 | 52.027843 |     1.0 |     0.5 | 0.440309 |     0.0 |
    ...
    | 2000-01-01 03:55:00 |  0.632218 |     1.0 |     0.5 | 0.701581 |     0.0 |
...
class Model(modeltools.SubstepModel):
    ...
    def check_waterbalance(self, initial_conditions: ConditionsModel) -> float:
        ...
        for name, model in self.find_submodels(include_subsubmodels=False).items():
            if isinstance(model, routinginterfaces.StorageModel_V1):
                ...
                assert isinstance(model, (r2, v2)), name
    ...
    def find_submodels(
        ...
        *,
        ...
        name2submodel = super().find_submodels(
            include_subsubmodels=include_subsubmodels,
            include_mainmodel=include_mainmodel,
            include_sidemodels=include_sidemodels,
            include_optional=include_optional,
            include_feedbacks=include_feedbacks,
            aggregate_vectors=aggregate_vectors,
            repeat_sharedmodels=repeat_sharedmodels,
            position=position,
        )
        if repeat_sharedmodels:
            return name2submodel
        if include_subsubmodels:
            return {n: s for n, s in name2submodel.items() if not n.startswith("model.channelmodels")}
        return name2submodel

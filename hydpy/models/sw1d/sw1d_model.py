...
class Pass_Discharge_V1(modeltools.Method):
    ...
    Examples:
        ...
        >>> e2.model.update_outlets()
        >>> #e2.model.pass_discharge_v1()
        >>> #e2.model._update_pointers_in(e2.model.sequences.inlets)
        >>> #e2.model._update_pointers_out(e2.model.sequences.outlets)
        >>> ni.sequences.sim
        sim(3.0)
        >>> no1.sequences.sim
        sim(4.0)

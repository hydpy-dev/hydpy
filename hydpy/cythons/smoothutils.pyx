...
estimation of this value would be advisable.
...
Smoothing kernel which combines `smooth_logistic1` and `smooth_logistic2`
for the regularization of functions containing two second order discontinuities.

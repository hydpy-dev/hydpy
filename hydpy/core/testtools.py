...
# from hydpy.models.wland import wland_constants  # actual import below
...
def prepare_interpolation_example() -> tuple[hydpytools.HydPy, pubtools.Pub]:
    ...
    10.0, 20.0, 30.0
    >>> print_vector(hp.nodes.in2.sequences.obs.series)
    40.0, 50.0, 60.0
    ...
    n_in2.deploymode = "obs"
    n_in2.sequences.obs.series = 40.0, 50.0, 60.0
...
def prepare_receiver_example() -> tuple[hydpytools.HydPy, pubtools.Pub]:
    ...
    l1 = devicetools.Element("l1", outlets="n1a")
    ...
    hp.update_devices(
        nodes=(n1a, n1b, n2, n3, n4), elements=(l1, l2, l3, d, s12, s23, s34)
    )
    hp.update_parameters()
...
def prepare_collective_example() -> tuple[hydpytools.HydPy, pubtools.Pub]:
    ...
    from hydpy.models.wland import wland_constants as consts
    ...
    p1 = devicetools.Element(
        "p1", inlets=g11_s1, outlets=s1_c1, receivers=(c1_s1, out_c3_s1)
    )
    p2 = devicetools.Element(
        "p2", inlets=g21_s2, outlets=s2_c2, receivers=(c2_s2, no_s1)
    )
    p3 = devicetools.Element(
        "p3", inlets=g31_s3, outlets=s3_c3, receivers=(c3_s3, no_s1)
    )
    ...
    p1.model, p2.model, p3.model = sluice_models
    ...
    hp.update_devices(
        ...
        # fmt: on
        elements=(g11, g12, g21, g22, g31, p1, p2, p3, c1, c2, c3)
    )
    hp.update_parameters()

...
cdef public int FOREST = 2
cdef public int GLACIER = 3
cdef public int FIELD = 1
cdef public int ILAKE = 4
@cython.final
cdef class ControlParameters(object):
    cdef public double area
    cdef public int nmbzones
    cdef public int[:] zonetype

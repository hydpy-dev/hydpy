...
class _Context:
    ...
    def __new__(
        ...
        args = [cls, option._get_value()] + list(args)
    ...
    def __call__(
        ...
        if (
            ...
            option._value = option._type(value)
        return self
...
class _PeriodContext(_Context, timetools.Period):
    ...
    def check(self) -> None:
        ...
        if not self._option._get_value():
            raise RuntimeError(
...
class _Option:
    ...
    TYPE2CONTEXT = {
        ...
        float: _FloatContext,
        str: _StrContext,
        timetools.Period: _PeriodContext,
    }
    ...
    def __get__(self, options, type_=None):
        context = self.TYPE2CONTEXT[self._type](option=self)
...
class Options:
    ...
    parameterstep = _Option(timetools.Period('1d'))

...
Application models of other model families, for example, |evap_ret_fao56|, require such
factors as input.  Users can either prepare the complete time series of these factors
during preprocessing and let |evap_ret_fao56| read them from files before or during a
simulation or couple |meteo_v001| and |evap_ret_fao56| to calculate global and clear
sky radiation "on the fly".
...
.. toctree::
   ...
   Meteo-Glob-IO <meteo_glob_io>
   Meteo-Clear-Glob-IO <meteo_clear_glob_io>
   Meteo-PSun-Sun-Glob-IO <meteo_psun_sun_glob_io>

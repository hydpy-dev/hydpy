...
"""Submodel for month-based land cover adjustments of reference evapotranspiration.

Use |evap_mlc| as a plug-in between a main model like |lland_v1| and another submodel
like |evap_tw2002| to adjust the reference evapotranspiration given by |evap_tw2002| by
month and land cover.
...
Application model |evap_mlc| does not define any land cover types by itself but takes
the ones of the respective main model.  Here, we manually introduce the land cover
types of grass, trees, and water to apply |evap_mlc| as a stand-alone model:
...
Application model |evap_mlc| requires no input from another model and does not supply

...
class PPDouble:
    ...
    def __getitem__(self, key: Union[int, slice]) -> typingtools.VectorFloat: ...
    def __setitem__(
        self, key: Union[int, slice], value: typingtools.VectorInputFloat
    ) -> None: ...
...
def check2(ready: typingtools.VectorInputFloat, length: int) -> None: ...

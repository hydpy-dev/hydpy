...
them to complex main models like |hland_96| for providing snow cover data.
...
value returned by method |Computes_SnowEvaporation_1|.  This method usually informs a
related evapotranspiration model whether a snow model computes snow evaporation
separately:

>>> computessnowevaporation(False)
>>> model.computes_snowevaporation()
False
...
class Model(modeltools.AdHocModel, stateinterfaces.SnowCoverModel_V1):
    """|dummy_snowcover.DOCNAME.complete|."""
